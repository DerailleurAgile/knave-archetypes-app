...
const ARCH_CAREERS = {
  ...
  blade:    ['bandit', 'beast tamer', 'blacksmith', 'butcher', 'carpenter', 'fence',
  ...
  shadow:   ['acrobat', 'actor', 'assassin', 'barber', 'bookbinder', 'burglar',
  ...
  endurer:  ['baker', 'beast tamer', 'boatman', 'brewer', 'cook', 'fisherman',
  ...
  sage:     ['alchemist', 'antiquarian', 'arcanist', 'architect', 'astrologer',
  ...
  wayfarer: ['beast tamer', 'beekeeper', 'boatman', 'courier', 'explorer', 'falconer',
  ...
  devoted:  ['acolyte', 'actor', 'courtier', 'cultist', 'inquisitor', 'jester',
